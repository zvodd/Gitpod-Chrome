...
#RUN sudo apt-get -q update && \
RUN sudo apt-get install -yq libnss3 libnspr4 && \
    sudo mkdir -p /tmp/cr/ && \
    ...
    sudo wget -q https://github.com/Eloston/ungoogled-chromium-binaries/releases/download/87.0.4280.67-1.unportable1/ungoogled-chromium-common_87.0.4280.67-1.unportable1_amd64.deb -O /tmp/cr/ungoogled-chromium-common.deb && \
    sudo dpkg -i /tmp/cr/ungoogled-chromium-common.deb && \
